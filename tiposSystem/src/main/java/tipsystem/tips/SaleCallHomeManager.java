...
public class SaleCallHomeManager extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sale_call_home_manager);
...
//		});
        homeIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(SaleCallHomeManager.this, MainMenuActivity.class);
...
//            @Override
//            public void onClick(View view) {
//                startActivity(new Intent(SaleCallHomeManager.this, TIPSPreferences.class));
//            }
//        });
