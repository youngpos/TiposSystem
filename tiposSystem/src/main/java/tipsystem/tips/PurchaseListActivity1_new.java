...
public class PurchaseListActivity1_new extends Activity implements AdapterView.OnItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_purchase_list1_new);
		//setupActionBar();
		// 매장 정보 불러 오기
		...
		*/
		//신규 등록 버튼
		Button buttonNewRegister = (Button)findViewById(R.id.buttonSendClose);
	...
	private void serachPurchaseList(){
		...
		*/
		...
		query = "Select * From int_"+tableName+" Where in_date='"+period+"' order by In_Seq ASC ";
