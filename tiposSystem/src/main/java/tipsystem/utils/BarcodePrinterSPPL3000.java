...
public class BarcodePrinterSPPL3000 extends Activity {

    String TAG = "SPP-L3000";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_barcode_printer_sppl3000);
    ...
    public void setReset(View view) {
        Toast.makeText(this, "설정을 초기화 합니다.", Toast.LENGTH_SHORT).show();
