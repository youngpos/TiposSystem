...
public class TipsSQLitHelper extends SQLiteOpenHelper {
    ...
    // 2023.03.03.김영목. 바코드프린터 설정값 초기화를 여기에 전역처리하여 전역으로 사용하자
    public String SqlBaPrintSPPL3000Create = "CREATE TABLE BaPrint_SPPL3000 ("
            ...
            + "Location_Setting TEXT, NickName_Setting TEXT,BranchName_Setting TEXT, AddItem_Setting TEXT);";

    public String SqlBaPrintSPPL3000Insert = "insert into BaPrint_SPPL3000(Print_Size, Lavel_Hight, Lavel_Width, Print_Direction, Paper_Gubun, Gap_Width, Print_StdSize_YN,"
