...
import tipsystem.tips.BarcodePrinterActivity;
...
public class DialogManager {
    ...
    public static void showBluetoothDialog(Context context, final Set<BluetoothDevice> pairedDevices) {
        ...
        new AlertDialog.Builder(context,AlertDialog.THEME_HOLO_LIGHT).setTitle("Paired Bluetooth printers")
                .setItems(items, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        BarcodePrinterActivity.mBixolonLabelPrinter.connect(strDeviceInfo);
    ...
    static void showUsbDialog(final Context context, final Set<UsbDevice> usbDevices, final BroadcastReceiver usbReceiver) {
        ...
        new AlertDialog.Builder(context).setTitle("Connected USB printers")
                .setItems(items, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        BarcodePrinterActivity.mBixolonLabelPrinter.connect((UsbDevice) usbDevices.toArray()[which]);
        ...
        if (ipAddressSet != null) {
            ...
            new AlertDialog.Builder(context).setTitle("Connectable network printers")
                    .setItems(items, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            BarcodePrinterActivity.mBixolonLabelPrinter.connect(items[which], 9100, 5000);
                        }
                    }).show();
        }
    }*/
    ...
    static void showPrinterInformationDialog(AlertDialog dialog, Context context, final BixolonLabelPrinter printer) {
        if (dialog == null) {
            ...
            dialog = new AlertDialog.Builder(context,AlertDialog.THEME_HOLO_LIGHT).setTitle("Get printer ID")
    ...
    static void showSetPrintingTypeDialog(AlertDialog dialog, Context context) {
        ...
        if (dialog == null) {
            ...
            dialog = new AlertDialog.Builder(context,AlertDialog.THEME_HOLO_LIGHT).setTitle("Set Printing Type")
                    .setSingleChoiceItems(ITEMS, 0, new OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            BarcodePrinterActivity.mBixolonLabelPrinter.setPrintingType(type);
                        }
            ...
            dialog = new AlertDialog.Builder(context).setTitle(R.string.set_margin).setView(view)
                    .setPositiveButton("OK", new OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            BarcodePrinterActivity.mBixolonLabelPrinter.setMargin(horizontalMargin, verticalMargin);
                        }
                    }).setNegativeButton("Cancel", new OnClickListener() {
                    ...
                    .setPositiveButton("OK", new OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            if (string != null && string.length() > 0) {
                                ...
                                BarcodePrinterActivity.mBixolonLabelPrinter.setWidth(labelWidth);
                            }
                        }
                    }).setNegativeButton("Cancel", new OnClickListener() {
                    ...
                    .setPositiveButton("OK", new OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            if (string1 != null && string1.length() > 0 && string2 != null && string2.length() > 0) {
                                ...
                                BarcodePrinterActivity.mBixolonLabelPrinter.setLength(labelLength, gapLength, mediaType, offsetLength);
                            }
                        }
                    }).setNegativeButton("Cancel", new OnClickListener() {
            ...
            dialog = new AlertDialog.Builder(context).setTitle("Set buffer mode")
                    .setSingleChoiceItems(new String[] {"false", "true"}, 0, new OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            BarcodePrinterActivity.mBixolonLabelPrinter.setBufferMode(mmCheckedItem == 1);
                        }
                    }).setNegativeButton("Cancel", new OnClickListener() {
                    ...
                    .setSingleChoiceItems(items, 0, new OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            switch (mmCheckedItem) {
                                case 0:
                                    BarcodePrinterActivity.mBixolonLabelPrinter.setSpeed(BixolonLabelPrinter.SPEED_25IPS);
                                    break;
                                case 1:
                                    BarcodePrinterActivity.mBixolonLabelPrinter.setSpeed(BixolonLabelPrinter.SPEED_30IPS);
                                    break;
                                case 2:
                                    BarcodePrinterActivity.mBixolonLabelPrinter.setSpeed(BixolonLabelPrinter.SPEED_40IPS);
                                    break;
                                case 3:
                                    BarcodePrinterActivity.mBixolonLabelPrinter.setSpeed(BixolonLabelPrinter.SPEED_50IPS);
                                    break;
                                case 4:
                                    BarcodePrinterActivity.mBixolonLabelPrinter.setSpeed(BixolonLabelPrinter.SPEED_60IPS);
                                    break;
                                case 5:
                                    BarcodePrinterActivity.mBixolonLabelPrinter.setSpeed(BixolonLabelPrinter.SPEED_70IPS);
                                    break;
                                case 6:
                                    BarcodePrinterActivity.mBixolonLabelPrinter.setSpeed(BixolonLabelPrinter.SPEED_80IPS);
                                    break;
                            }
                        }
                    }).setNegativeButton("Cancel", new OnClickListener() {
            ...
            dialog = new AlertDialog.Builder(context).setTitle(R.string.set_density).setView(view)
                    .setPositiveButton("OK", new OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            BarcodePrinterActivity.mBixolonLabelPrinter.setDensity(density);
                        }
                    }).setNegativeButton("Cancel", new OnClickListener() {
            ...
            dialog = new AlertDialog.Builder(context).setTitle("Set orientation")
                    .setSingleChoiceItems(new String[] {"Print from top to bottom (default)", "Print from bottom to top"}, 0, new OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            if (mmCheckedItem == 0) {
                                BarcodePrinterActivity.mBixolonLabelPrinter.setOrientation(BixolonLabelPrinter.ORIENTATION_TOP_TO_BOTTOM);
                            } else {
                                BarcodePrinterActivity.mBixolonLabelPrinter.setOrientation(BixolonLabelPrinter.ORIENTATION_BOTTOM_TO_TOP);
                            }
                        }
                    }).setNegativeButton("Cancel", new OnClickListener() {
            ...
            dialog = new AlertDialog.Builder(context).setTitle(R.string.set_offset).setView(view)
                    .setPositiveButton("OK", new OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            BarcodePrinterActivity.mBixolonLabelPrinter.setOffset(offset);
                        }
                    }).setNegativeButton("Cancel", new OnClickListener() {
            ...
            dialog = new AlertDialog.Builder(context).setTitle("Cutter position setting").setView(view)
                    .setPositiveButton("OK", new OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            BarcodePrinterActivity.mBixolonLabelPrinter.setCutterPosition(position);
                        }
                    }).setNegativeButton("Cancel", new OnClickListener() {
            ...
            dialog = new AlertDialog.Builder(context).setTitle(R.string.cutting_action).setView(view)
                    .setPositiveButton("OK", new OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            BarcodePrinterActivity.mBixolonLabelPrinter.setAutoCutter(radioGroup.getCheckedRadioButtonId() == R.id.radio0, cuttingPeriod);
                        }
                    }).setNegativeButton("Cancel", new OnClickListener() {
